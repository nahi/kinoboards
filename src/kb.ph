...
$H_NOBACKART = "以前に書き込まれた$H_MESGはありません";
$H_NONEXTART = "以降に書き込まれた$H_MESGはありません";
$H_TOP = "↑";
$H_BOTTOM = "↓";
$H_REVERSE = "△▽";
...
# $Id: kb.ph,v 5.11 1998-12-10 11:29:11 nakahiro Exp $
